...
This file tracks remaining and future work for the `gk eval` recorded-video evaluator. Current user-facing behavior belongs in `cli/README.md`, and contributor guidance belongs in `cli/AGENTS.md`.
