...
- `uv run --with-editable ../../../cli --env-file .env glasskit eval run --adapter eval_adapter.py:create_evaluator --eval-dir eval-suite`: run a local recorded-video eval suite
