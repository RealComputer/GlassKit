...
DEMO_FPS = 5
FOLD_CHECK_VIDEO_FPS = 5
FOLD_CHECK_PUBLISH_MAX_BITRATE_BPS = 5_000_000
FOLD_CHECK_PROMPT_INTERVAL_SECONDS = 0.5
OVERSHOOT_KEEPALIVE_INTERVAL_SECONDS = 90.0
FOLD_CHECK_STREAM_READY_TIMEOUT_SECONDS = 15.0
FOLD_CHECK_RECONNECT_INGEST_TIMEOUT_SECONDS = 15.0
FOLD_CHECK_STREAM_STATUS_POLL_SECONDS = 0.5
...
FOLD_CHECK_STEP_RESULT_GRACE_SECONDS = 0.6
