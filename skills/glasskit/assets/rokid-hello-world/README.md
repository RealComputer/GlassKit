...
This starter comes from [GlassKit](https://github.com/RealComputer/GlassKit). For best results, install the GlassKit agent skill so your AI coding agent has the smart-glasses context it needs: Rokid device constraints, sensor access patterns, and HUD/input best practices.
