...
This app is generated by [GlassKit](https://github.com/RealComputer/GlassKit). If not yet, it's recommended to install the Agent Skills so that your AI coding agents have proper knowledge and can work effectively.
