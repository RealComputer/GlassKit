...
- `references/proactive-app-pattern.md`: high-level pattern for proactive glasses apps where continuous observations drive workflow state, wearer feedback, and actions.
