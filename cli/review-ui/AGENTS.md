...
- Edit a sample's timestamp, expectation type and value, field, comparison mode, tolerance, comment, and ignore reason in the inspector, or delete the sample when deletion is valid.
