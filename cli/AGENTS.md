...
- `src/glasskit/eval/expectations.py` and `src/glasskit/eval/schemas.py`: suite discovery, YAML parsing, timestamp expansion, target config merging, and thresholds.
